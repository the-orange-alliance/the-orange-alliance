...
import {ApplicationActions, ISetTotalEventSize, ISetTotalTeamSize} from "./Actions";
...
const reducer: Reducer<Types.IApplicationState, ApplicationActions> = (state: Types.IApplicationState = defaultState, action: ApplicationActions) => {
  switch (action.type) {
