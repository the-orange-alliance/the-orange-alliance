...
const ApiDocs = () => {
  return (
    <Container sx={{ py: 6 }}>
      ...
      <Typography>
        Data related to a specific team is often submitted directly by that team. This data can only
        be updated via the{' '}
        <Link
        ...
        by Lead Mentors 1 and 2, and generally takes about 24 hours to appear on The Orange Alliance
        once submitted.
      </Typography>
      ...
      <Typography>
        Data related to official events come directly from the <em>FIRST</em> Tech Challenge Scoring
        System. Please refer to "Uploading Event Data to <em>FIRST</em>" in the{' '}
        <Link
