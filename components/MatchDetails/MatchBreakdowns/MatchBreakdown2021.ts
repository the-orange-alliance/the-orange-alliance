...
import {
  ...
  MatchBreakdownRow,
  MatchBreakdownTitle,
  MatchBreakdownUltimateGoalWobbleField
} from '../MatchBreakdownRow';
import UltimateGoalAllianceDetails from '@the-orange-alliance/api/lib/cjs/models/game-specifics/2021/UltimateGoalAllianceDetails';
import UltimateGoalMatchDetails from '@the-orange-alliance/api/lib/cjs/models/game-specifics/2021/UltimateGoalMatchDetails';

export default class MatchBreakdown2021 {
  getRows(match: Match): MatchBreakdownRow[] {
    const details: UltimateGoalMatchDetails = new UltimateGoalMatchDetails().fromJSON(
    ...
    return [
      ...
      MatchBreakdownField(
        'PowerShots Successfully Launched Back',
        red.autoPowerShotPoints / 15,
        blue.autoPowerShotPoints / 15,
        15
      ),
      MatchBreakdownBoolField(
        'Wobble Goal 1 Delivered',
        red.wobbleDelivered1,
        blue.wobbleDelivered1,
        15
      ),
      MatchBreakdownBoolField(
        'Wobble Goal 2 Delivered',
        red.wobbleDelivered2,
        blue.wobbleDelivered2,
        15
      ),
      ...
      MatchBreakdownUltimateGoalWobbleField(
        'Wobble Goal 1 End Position',
        red.wobbleEnd1,
        blue.wobbleEnd1
      ),
      MatchBreakdownUltimateGoalWobbleField(
        'Wobble Goal 2 End Position',
        red.wobbleEnd2,
        blue.wobbleEnd2
      ),
      MatchBreakdownField(
        'PowerShots Successfully Launched Back',
        red.endPowerShotPoints / 15,
        blue.endPowerShotPoints / 15,
        15
      ),
