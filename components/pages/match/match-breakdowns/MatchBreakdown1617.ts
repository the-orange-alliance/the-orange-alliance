...
export default class MatchBreakdown1617 {
  getRows(match: Match): MatchBreakdownRow[] {
    const details: VelocityVortexMatchDetails = new VelocityVortexMatchDetails().fromJSON(
    ...
    return [
      ...
      MatchBreakdownVelocityVortexParkingField(
        'Robot One Parked',
        details.redAutoRobot1,
        details.blueAutoRobot1
      ),
      MatchBreakdownVelocityVortexParkingField(
        'Robot Two Parked',
        details.redAutoRobot2,
        details.blueAutoRobot2
      ),

      MatchBreakdownTitle(
        'Teleop',
        match.redTeleScore + match.redEndScore,
        match.blueTeleScore + match.blueEndScore
      ),
