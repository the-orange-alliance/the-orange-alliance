...
import {
  ...
  MatchBreakdownField,
  MatchBreakdownFreightFrenzyBarcodeElement,
  MatchBreakdownFreightFrenzyParkingLocation,
  MatchBreakdownRow,
  MatchBreakdownTitle
} from '../match-breakdown-row';
import FreightFrenzyAllianceDetails from '@the-orange-alliance/api/lib/cjs/models/game-specifics/2122/FreightFrenzyAllianceDetails';
import FreightFrenzyMatchDetails from '@the-orange-alliance/api/lib/cjs/models/game-specifics/2122/FreightFrenzyMatchDetails';

export default class MatchBreakdown2122 {
  getRows(match: Match): MatchBreakdownRow[] {
    const details: FreightFrenzyMatchDetails = match.details as FreightFrenzyMatchDetails;
    ...
    return [
      ...
      MatchBreakdownField(
        'Storage Unit Freight',
        red.teleStorageFreight,
        blue.teleStorageFreight,
        1
      ),
      ...
      MatchBreakdownField(
        'Duck or Shipping Element Delivered',
        red.endDelivered,
        blue.endDelivered,
        6
      ),
      ...
      MatchBreakdownField('Shipping Hub Capped', red.capped, blue.capped, 15),
      MatchBreakdownBoolField(
        'Alliance Hub Balanced',
        red.allianceBalanced,
        blue.allianceBalanced,
        10
      ),
      MatchBreakdownBoolField(
        'Shared Hub Unbalanced',
        red.sharedUnbalanced,
        blue.sharedUnbalanced,
        20
      ),
      MatchBreakdownFreightFrenzyParkingLocation(
        'Robot 1 Navigated',
