...
export default class MatchBreakdown1718 {
  getRows(match: Match): MatchBreakdownRow[] {
    const details: RelicRecoveryMatchDetails = new RelicRecoveryMatchDetails().fromJSON(
      match.details.toJSON()
    );
    return [
      MatchBreakdownTitle('Autonomous', match.redAutoScore, match.blueAutoScore),
      MatchBreakdownField(
        'Single Jewel Remaining',
        details.redAutoJewels,
        details.blueAutoJewels,
        30
      ),
      ...
      MatchBreakdownField(
        'Columns in Cryptoboxes',
        details.redTeleColumns,
        details.blueTeleColumns,
        20
      ),
      ...
      MatchBreakdownField(
        'Relics Upright',
        details.redEndRelicStanding,
        details.blueEndRelicStanding,
        15
      ),
      MatchBreakdownField(
        'Robots Balanced',
        details.redEndRobotBalances,
        details.blueEndRobotBalances,
        20
      ),
