...
// A styled version of the Next.js NextMuiLink component:
// https://nextjs.org/docs/#with-link
const NextMuiLink = React.forwardRef<HTMLAnchorElement, LinkProps>(function Link(props, ref) {
  const {
    ...
    href,
    noLinkStyle,
    role, // NextMuiLink don't have roles.
    ...other
  } = props;
