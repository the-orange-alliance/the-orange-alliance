...
import { Card, Grid, Typography, List, ListItem, IconButton, Menu, MenuItem, ListItemIcon, ListItemText } from "@mui/material";
import { Team, Event } from "@the-orange-alliance/api/lib/cjs/models";
import { useEffect, useState } from "react";
import { useTranslate } from "../../i18n/i18n";
import { useAppContext } from "../../lib/toa-context";
import TOAUser from "../../lib/TOAUser";
import { removeFromFavorite, setNotifications } from "../../providers/FirebaseProvider";
import TOAProvider from "../../providers/TOAProvider";
import { myTOAType } from "../MyTOAFavorite";
import SimpleEventPaper from "../SimpleEventPaper";
...
const FavoritesMenu = ({ type, dataKey }: IMenuProps) => {
  ...
  const t = useTranslate();
  const [notify, setNotify] = useState(type === 'team' ? user?.notifyTeams.includes(dataKey) : user?.notifyEvents.includes(dataKey));
